 ...
 * *Traeffik* that acts as the reverse proxy, forwarding incoming requests to the different internal systems
...
This is a very central file so I will explain this in detail:
