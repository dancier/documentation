...
To understand what you are installing here, it is important you have some knowledge about docker-compose.
...
a certain use case. In this case it is, having a full featured Nextcloud installation with an office suite running.
