...
[IMPORTANT]
.New Version of this How-To in progress
====
I acutally am writing a new new How-To on this topic.
It is available on link:https://coden.in-der-kothe.de/setting-up-nextcloud-with-ansible-terraform-in-hetzner-cloud-en.html[Coden in der Kothe]. This one will not receive any updates.
====
