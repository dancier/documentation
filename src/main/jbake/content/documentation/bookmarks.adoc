...
== Architecture
* link:https://www.datadoghq.com/blog/monitoring-101-collecting-data/[Monitoring 101 Collecting Data]
...
* link:https://docs.spring.io/spring-data/jpa/docs/current/reference/html/#preface[Spring Data - JPA]
* link:https://www.baeldung.com/jpa-queries-custom-result-with-aggregation-functions[Baeldung - JPA Queries - Aggregation Function]
