...
This is about the tech stack of technology we agreed on.

It's a result of applying our https://project.dancier.net/technology-descision-principles.html[Technology Decision Principles] to our domain.
