...
By this, we are providing publicly accessible examples that hopefully can help others to e.g. setup a software project on their own.
...
Contributing is not only possible through technically. You can also:
